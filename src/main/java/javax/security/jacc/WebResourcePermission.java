...
public final class WebResourcePermission extends Permission implements Serializable {
     ...
     *        permission is constructed with the empty string as its name. The permission's actions field is obtained from
     ...
     * 
     * The name contains a URLPatternSpec that identifies the web resources to which the permissions applies. The syntax of a
     ...
     * 
     * The actions parameter contains a comma seperated list of HTTP methods. The syntax of the actions parameter is defined as
     * follows:
     * 
     * HTTPMethod ::= "GET" | "POST" | "PUT" | "DELETE" | "HEAD" | "OPTIONS" | "TRACE"
     * 
     * HTTPMethodExceptionList ::= exclaimationPoint HTTPMethodList HTTPMethodList ::= HTTPMethod | HTTPMethodList comma
     * HTTPMethod HTTPMethodSpec ::= null | emptyString | HTTPMethodExceptionList | HTTPMethodList
     * 
     * 
     ...
     * @param actions - identifies the HTTP methods to which the permission pertains. If the value passed through this parameter
     *        is null or the empty string, then the permission is constructed with actions corresponding to all the possible
     *        HTTP methods.
     */
    ...
    /**
     * Creates a new WebResourcePermission with name corresponding to the URLPatternSpec, and actions composed from the array of
     * HTTP methods.
     * 
     * @param urlPatternSpec - the URLPatternSpec that identifies the app specific web resources to which the permission
     ...
     *        corresponding to all the possible HTTP methods.
     */
    ...
    /**
     * Returns a canonical String representation of the actions of this WebResourcePermission. WebResourcePermission actions are
     * canonicalized by sorting the HTTP methods into ascending lexical order. There may be no duplicate HTTP methods in the
     * canonical form, and the canonical form of the set of all HTTP methods is the value null.
     * 
     ...
     * called on a WebResourcePermission object. The value returned by hashCode for a particular WebResourcePermission need not
     * remain consistent from one execution of an application to another. - If two WebResourcePermission objects are equal
     ...
     * 
     * - The argument is an instanceof WebResourcePermission - The first URLPattern in the name of the argument permission is
     ...
     * are a subset of the HTTP methods in the actions of this permission.
     * 
    ...
    /**
     * Build a permission name from the substring of the HttpServletRequest.getRequestURI()) that begins after the contextPath
     * (HttpServletRequest.getContextPath()). When the substring operation yields the string "/", the permission is constructed
     * with the empty string as its name.
     * 
